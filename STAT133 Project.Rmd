...
data1 <- data %>% mutate(movie_title=gsub('\x8c\xe6', '', movie_title))
genres <- data1 %>% separate(genres, c('genre1', 'genre2', 'genre3', 'genre4', 'genre5', 'genre6', 'genre7'), sep = "\\|")
plotwords  <- data1 %>% separate(plot_keywords, c('plotword1', 'plotword2', 'plotword3', 'plotword4', 'plotword5'), sep = "\\|")
